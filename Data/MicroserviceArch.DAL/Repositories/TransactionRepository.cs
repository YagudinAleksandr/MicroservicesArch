...
{
    public class TransactionRepository<T> : ITransactionRepository<T> where T : TransactionEntity
    {
        ...
        public Task<List<T>> GetAllByCount(int countId, CancellationToken cancel = default)
        {
            throw new NotImplementedException();
        }
